...
//				.tasksProcessingOrder(QueueProcessingType.LIFO).discCacheFileCount(200)// 缓存的File数量
//				.discCache(new LimitedAgeDiskCache(cacheDir,1000))// 自定义缓存路径
//				.defaultDisplayImageOptions(getOptionsDefault())
...
//	{
//		return getFadeOptions(R.drawable.tupian_fallback_bg, R.drawable.tupian_fallback_bg, R.drawable.tupian_fallback_bg);
//	}
//	/**
//	 * 其他的预加载图片组合
//	 *
...
//	{
//		return getFadeOptions(R.drawable.tupian_fallback_bg, R.drawable.course_defult, R.drawable.course_defult);
//	}
//	/**
//	 * 头像的预加载图片组合
//	 *
//	 * @return
//	 */
//	public static DisplayImageOptions getFadeOptionsDefault1()
//	{
//		return getFadeOptions(R.drawable.head, R.drawable.head, R.drawable.head);
//	}
//
//	/**
//	 * 获取默认显示配置选项
